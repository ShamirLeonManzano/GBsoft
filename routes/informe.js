...
import { existeInformeById, existeTipo, existeInformeByCod, existeUsuarioById, existeGbById} from '../helpers/informe.js';
...
router.post('/',[
    ...
    check('totalAm', 'El total de Asistencia es obligatorio').notEmpty(),
    ...
    check('iDL', 'El IDL es obligatorio').notEmpty(),
    check('iDL').custom(existeInformeByCod),
